...
def get_dataloader(train_batch_size,eval_batch_size,dataset,seed=None,w_aug=True,w_double=False,label_list=None):
    if w_aug:
        if w_double:
            with open('./preprocessed_data/'+dataset+'/'+dataset+'_double_syn_preprocessed_bert.pkl', "rb") as f:
                data = pickle.load(f)
        else:
            with open('./preprocessed_data/'+dataset+'/'+dataset+'_waug_syn_preprocessed_bert.pkl', "rb") as f:
                data = pickle.load(f)
    else:
        with open('./preprocessed_data/'+dataset+'/'+dataset+'_preprocessed_bert.pkl', "rb") as f:
            data = pickle.load(f)
